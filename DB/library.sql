...
INSERT INTO `novel` (`id`, `title`, `author`, `cover_image_url`, `number_of_chapters`, `year_published`, `description`, `sub_genre`) VALUES (2, 'The sirens of tita', 'Kurt Vonnegut', 'https://prodimage.images-bn.com/pimages/9780385333498_p0_v1_s1200x630.jpg', 13, 1959, 'Malachi Constant is the richest man in a future America. He possesses extraordinary luck that he attributes to divine favor which he has used to build upon his father\'s fortune. He becomes the centerpoint of a journey that takes him from Earth to Mars in preparation for an interplanetary war, to Mercury with another Martian survivor of that war, back to Earth to be pilloried as a sign of Man\'s displeasure with his arrogance, and finally to Titan where he again meets the man ostensibly responsible for the turn of events that have befallen him, Winston Niles Rumfoord.', 'alternate history');
